...
static char *Buffio_allBuffer(Buffio *buffio) { return buffio->data; }
...
// int Buffio_ReadLine(Buffio* buffio,uint8_t* buffer, int maxLen, uint8_t
// delim) {
//     int count = 0;
...
static int Buffio_ReadLine(Buffio *buffio, char *buffer, int maxLen,
                           const char *delim) {
    int count = 0;
